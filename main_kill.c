...
/*   Updated: 2017/05/07 18:41:26 by rhadiats         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//*
	...
	PRINTF("|%S|\t|%S|",L"Wide sample string..",L"米");
...
//*
	...
	PRINTF("|d/D|\t|%zd|\t|%zd|\t|%zD|%zD|", 0, LLONG_MAX, 0, USHRT_MAX);
	PRINTF("|u/U|\t|%zu|\t|%zu|\t|%zU|%zU|", 0, ULLONG_MAX, 0, USHRT_MAX);
	PRINTF("|o/O|\t|%zo|\t|%zo|\t|%zO|%zO|", 0, ULLONG_MAX, 0, USHRT_MAX);
	PRINTF("|d/D|\t|%zx|\t|%zx|\t|%zX|%zX|", 0, ULLONG_MAX, 0, USHRT_MAX);
	//Not number options
